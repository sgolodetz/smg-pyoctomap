...
class ColorOcTree:
	...
	def insert_point_cloud(self, scan: Pointcloud, colours: np.ndarray, sensor_origin: Vector3, max_range: float = -1.0, lazy_eval: bool = False, discretize: bool = False) -> None: ...
	def prune(self) -> None: ...
